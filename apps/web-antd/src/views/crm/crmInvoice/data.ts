...
export const querySchema: FormSchemaGetter = () => [
  ...
  },
  {
    ...
    fieldName: 'status',
    label: '发票状态 -1：开票撤回；0：待开票；1：已开票；2:已拒绝；3：申请作废；4:同意作废；5：拒绝作废；6：作废撤回；',
  },
  {
    component: 'Input',
    fieldName: 'invalid',
...
export const columns: VxeGridProps['columns'] = [
  ...
  {
    title: '发票状态 -1：开票撤回；0：待开票；1：已开票；2:已拒绝；3：申请作废；4:同意作废；5：拒绝作废；6：作废撤回；',
    field: 'status',
    slots: {
      default: ({ row }) => {
        // 可选从DictEnum中获取 DictEnum.INVOICE_STATUS 便于维护
  ...
  {
    title: '作废状态: 0，默认；-1，撤回；1，待审核；2，审核通过；3，审核未通过',
    field: 'invalid',
  },
  {
    title: '开票日期',
